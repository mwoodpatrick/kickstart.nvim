...
-- FIXME: machine-specific path; adjust if you move this config to another system
...
-- ============================================================
-- SECTION 1-2: OPTIONS & KEYMAPS
-- Core settings, leader, keymaps, and basic autocommands.
-- These are maintained in lua/config/options.lua and lua/config/keymaps.lua
-- so init.lua stays focused on plugin setup.
-- ============================================================
